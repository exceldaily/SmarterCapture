...
export const recipes: Recipe[] = [
  { id: "a6-offshore-fishing", name: "Offshore Fishing", emoji: "🎣", cameraId: a6, verified: true,
    note: "The classic CamCue setup — smooth action, strike-proof with Pre-Record.",
    scenario: { sceneId: "fishing", light: "bright-sun", mount: "boat", platform: "youtube", movement: "fast" } },
  { id: "a6-shore-fishing", name: "Shore Fishing", emoji: "🏖", cameraId: a6, verified: true,
    note: "Tripod-friendly wide setup for bank and surf sessions.",
    scenario: { sceneId: "fishing", light: "partly-cloudy", mount: "tripod", platform: "youtube", movement: "moderate" } },
  { id: "a6-kayak-fishing", name: "Kayak Fishing", emoji: "🛶", cameraId: a6, verified: true,
    note: "Low to the water, lots of paddle splash — wind reduction on.",
    scenario: { sceneId: "fishing", light: "bright-sun", mount: "boat", platform: "youtube", movement: "moderate" } },
  { id: "a6-chest-fishing", name: "Chest-Mount Fishing", emoji: "🎽", cameraId: a6, verified: true,
    note: "Hands-free POV that shows rod, reel and water.",
    scenario: { sceneId: "fishing", light: "bright-sun", mount: "chest", platform: "youtube", movement: "fast" } },
  { id: "a6-fish-strike", name: "Fish Strike", emoji: "⚡", cameraId: a6, verified: true,
    note: "Built for the 3 seconds that matter — slow-motion ready.",
    scenario: { sceneId: "fishing", light: "bright-sun", mount: "chest", movement: "extreme", priority: "slowmo" } },
  { id: "a6-fish-landing", name: "Fish Landing", emoji: "🥅", cameraId: a6, verified: true,
    note: "Wide view so the net, fish and angler all stay in frame.",
    scenario: { sceneId: "fishing", light: "bright-sun", mount: "handheld", movement: "fast" } },
  { id: "a6-fish-release", name: "Fish Release", emoji: "🙌", cameraId: a6, verified: true,
    note: "Slow motion turns a release into the hero moment.",
    scenario: { sceneId: "fishing", light: "bright-sun", mount: "handheld", movement: "moderate", priority: "slowmo" } },
  { id: "a6-underwater-release", name: "Underwater Release", emoji: "💦", cameraId: a6, verified: true,
    note: "Half-in, half-out water shots — the money clip.",
    scenario: { sceneId: "underwater", light: "bright-sun", mount: "handheld", movement: "moderate", priority: "slowmo" } },
